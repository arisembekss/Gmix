...
public class FragmentColc extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myRef = database.getReference(Config.REF_DB+Config.REF_3);//TODO change dbase reference
    ...
    private void initUi() {
        ruanga = (sharedPreferences.getString(Config.RUANGA5, ""));//TODO change preference
        ruangb = (sharedPreferences.getString(Config.RUANGA6, ""));//TODO change preference
        ...
        lay1.setBackgroundResource(R.color.blue2);
        lay2.setBackgroundResource(R.color.blue1);

        tblok = (TextView) view.findViewById(R.id.textblok);
        tblok.setText("BLOK C");//TODO change blok text
