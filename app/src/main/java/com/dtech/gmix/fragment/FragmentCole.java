...
public class FragmentCole extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myRef = database.getReference(Config.REF_DB+Config.REF_5);//TODO change dbase reference
    ...
    private void initUi() {
        ruanga = (sharedPreferences.getString(Config.RUANGA9, ""));//TODO change preference
        ruangb = (sharedPreferences.getString(Config.RUANGA10, ""));//TODO change preference
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imgbtn1:
                prefManager.setRuangi(ed1.getText().toString());//TODO change ruang preference
                ed1.setFocusable(false);
                imm.hideSoftInputFromWindow(getView().getWindowToken(), 0);
                imgbtn1.setVisibility(View.GONE);
                break;
            case R.id.imgbtn2:
                prefManager.setRuangj(ed2.getText().toString());//TODO change ruang preference
