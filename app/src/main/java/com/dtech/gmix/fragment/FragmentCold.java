...
public class FragmentCold extends Fragment implements View.OnClickListener {
    ...
    private void initUi() {
        ruanga = (sharedPreferences.getString(Config.RUANGA7, ""));//TODO change preference
        ruangb = (sharedPreferences.getString(Config.RUANGA8, ""));//TODO change preference
        ...
        lay1.setBackgroundResource(R.color.amber2);
        lay2.setBackgroundResource(R.color.amber1);
        tblok = (TextView) view.findViewById(R.id.textblok);
        tblok.setText("BLOK D");//TODO change blok text
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imgbtn1:
                prefManager.setRuangg(ed1.getText().toString());//TODO change ruang preference
                ed1.setFocusable(false);
                imm.hideSoftInputFromWindow(getView().getWindowToken(), 0);
                imgbtn1.setVisibility(View.GONE);
                break;
            case R.id.imgbtn2:
                prefManager.setRuangh(ed2.getText().toString());//TODO change ruang preference
