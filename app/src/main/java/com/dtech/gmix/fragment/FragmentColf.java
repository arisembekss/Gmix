...
public class FragmentColf extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myRef = database.getReference(Config.REF_DB+Config.REF_6);//TODO change dbase reference
    ...
    private void initUi() {
        ...
        lay1.setBackgroundResource(R.color.deeppurple2);
        lay2.setBackgroundResource(R.color.deeppurple1);
